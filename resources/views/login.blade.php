            ...
            <div class="px-6 py-4">
                <form action="/login" method="POST">
                    ...
                    <div class="mb-4 flex items-center">
                        <input type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" id="remember" name="remember" value="remember" {{ old('remember') == 'remember' ? 'checked' : '' }}>
